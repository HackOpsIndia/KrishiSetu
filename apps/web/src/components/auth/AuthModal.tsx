        ...
        <div className="p-6">
          ...
          {activeTab === 'GOOGLE' && (
            <div className="space-y-4 py-1">
              ...
              {/* Verified Identity linkage badge */}
              <div className="p-2.5 rounded-xl bg-neutral-50 border border-neutral-200 text-[10px] text-neutral-500 text-left leading-relaxed flex items-start gap-2">
                <ShieldCheck className="w-3.5 h-3.5 text-emerald-600 shrink-0 mt-0.5" />
                <div>
                  <span className="font-semibold text-neutral-700">OAuth 2.0 Identity: </span>
                  <span className="font-mono text-[9px] text-neutral-600">Enterprise Verified • Google Cloud Platform Linkage</span>
                </div>
              </div>
            </div>
          )}
