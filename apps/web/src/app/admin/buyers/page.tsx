      ...
      if (Array.isArray(opps) && opps.length > 0) {
        setBuyers(
          opps.map((o) => ({
            id: o.id,
            name: o.name,
            type: o.buyerType || 'Buyer',
            location: o.location,
            trustScore: Math.round((o.trustScore || 0.5) * 100),
            tradesCount: o.completedTransactions || 0,
            avgSettlementHours: o.paymentReliability ? (100 - o.paymentReliability) / 10 : 0,
            disputeRate: o.disputes ? `${((o.disputes / Math.max(o.completedTransactions || 1, 1)) * 100).toFixed(1)}%` : '0.0%',
            status: o.verificationLevel || 'PROFILE_COMPLETE',
            gstin: o.gstin || 'Not provided',
            fssai: o.fssai || 'Not provided',
            escrowBank: o.escrowBank || 'Platform Escrow',
